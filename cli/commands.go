...
import (
	...
	okrrender "github.com/grokify/prism-roadmap/goals/okr/render"
	okrmarp "github.com/grokify/prism-roadmap/goals/okr/render/marp"
	"github.com/grokify/prism-roadmap/goals/v2mom"
	v2momrender "github.com/grokify/prism-roadmap/goals/v2mom/render"
	v2mommarp "github.com/grokify/prism-roadmap/goals/v2mom/render/marp"
...
func runPRDListSections(cmd *cobra.Command, args []string) error {
	...
	fmt.Println()
	fmt.Println("Example:")
	fmt.Println("  splan requirements prd generate myproduct.json --order=executiveSummary,problem,solution")
