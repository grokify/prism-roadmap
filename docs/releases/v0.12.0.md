...
This release integrates prism-roadmap with [prism-core](https://github.com/grokify/prism-core), the foundational library for the PRISM ecosystem. Common types are now imported from prism-core, ensuring consistency across prism-capability, prism-intelligence, and prism-roadmap.
