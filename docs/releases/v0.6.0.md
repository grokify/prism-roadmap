...
See [MIGRATION_CAMELCASE.md](https://github.com/grokify/structured-plan/blob/main/MIGRATION_CAMELCASE.md) for the complete field mapping.
...
- [`MIGRATION_CAMELCASE.md`](https://github.com/grokify/structured-plan/blob/main/MIGRATION_CAMELCASE.md) - Complete migration documentation with field mapping
